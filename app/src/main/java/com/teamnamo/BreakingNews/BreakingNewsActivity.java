...
public class BreakingNewsActivity extends AppCompatActivity {
    ...
    List<BreakingNewsModal> breakingNewsModalList = new ArrayList<>();
    BreakingNewsModal breakingNewsModal;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        breakingNewsAdapter = new BreakingNewsAdapter(breakingNewsModalList,this);
        linearLayoutManager = new LinearLayoutManager(this);
        //rv_notification.setNestedScrollingEnabled(false);
        rv_video_list.setLayoutManager(linearLayoutManager);

        rv_video_list.setAdapter(breakingNewsAdapter);
    ...
    public void loadMoreItems(){
        ...
        Call<JsonElement> call = customAdApiInterface.getBreakingNews(pageNumber);
                    ...
                    if (response.isSuccessful()) {
                        ...
                        if(jsonObject!=null){
                            ...
                            for(int i =0;i<jsonArray.length();i++){
                                ...
                                breakingNewsModal = new BreakingNewsModal(jsonObject1.getString("description"),
                                        jsonObject1.getString("publishedat")
                                );
                                breakingNewsModalList.add(breakingNewsModal);
                            }

                            if(breakingNewsModalList.size()>0){
            ...
            public void onResponse(Call<JsonElement> call, Response<JsonElement> response) {
                ...
                try {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        JSONObject jsonObject= new JSONObject(response.body().toString());
                        if(jsonObject!=null){
                            breakingNewsModalList.clear();
                            pageNumber++;
                            Log.e("newsModalList",breakingNewsModalList.size()+"newsModalList");
